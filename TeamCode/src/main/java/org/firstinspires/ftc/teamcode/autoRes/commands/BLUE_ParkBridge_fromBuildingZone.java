 ...
 *
 * Assumes Blue alliance, starting on building zone.
 * Steps:
...
@Autonomous(name = "BLUE-ParkBridge_fromBuildingZone", group = "Park")
public class BLUE_ParkBridge_fromBuildingZone extends LinearOpMode {
