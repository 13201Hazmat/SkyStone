...
public class AutoUC5_2Skystone_MoveFdn_Park {
    ...
    private int secondBlockDelta = 0;
    ...
    public boolean AutoUC5_2Skystone_MoveFdn_Park_Method(
        ...
        if (!targetVisible) {
            autoUCChassis.runFwdBackLeftRight(stoneTostone, playingAlliance, 0.2, callingOpMode);
            skystonePosition = 4;
        }//end of if
        ...
        autoUCChassis.runFwdBackLeftRight(5, 0, 0.2, callingOpMode);
        ...
        autoUCChassis.runFwdBackLeftRight(-8, 0, 0.2, callingOpMode); // distance was 8
        ...
        autoUCChassis.runFwdBackLeftRight(expectedMaxDistanceToFoundation, 0, 0.9, callingOpMode);
        ...
        if (skystonePosition == 3 || skystonePosition == 5) {
            ...
            // Move Back
            autoUCChassis.runFwdTill_frontChassisTouchSensor_Pressed(-10, 0.25, callingOpMode);
            ...
            callingOpMode.sleep(100);
            // Move Back
            autoUCChassis.runFwdTill_frontChassisTouchSensor_Pressed(81 + secondBlockDelta, 0.9, callingOpMode);
            ...
            // Forward
            autoUCChassis.runFwdBackLeftRight(105, 0, 0.9, callingOpMode);
            ...
            //Move forward till Chassis bumber limit switch is pressed
            autoUCChassis.runFwdTill_frontChassisTouchSensor_Pressed(18, 0.9, callingOpMode);
        ...
        */
            ...
            autoUCChassis.runFwdBackLeftRight(35, playingAlliance, 0.9, callingOpMode);
            ...
            if (parkingPlaceNearSkyBridge) {
                autoUCChassis.runFwdBackLeftRight(25, 0, 0.2, callingOpMode);
            }
