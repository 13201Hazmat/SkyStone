...
/**
 * Defenition of the HzGamepad Class with No Wrist
 *
...
public class HzGamepad1NoWrist {
     ...
     */
    public HzGamepad1NoWrist(Gamepad gamepadPassedfromOpMode) {
     ...
     */
    public void runSubsystemByGamepadInput(Chassis gpChassis, Arm gpArm, IntakeNoWrist gpIntake) {
